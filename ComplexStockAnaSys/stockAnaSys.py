...
_excelsPath = 'F:\\data\\stock_' + _todayTime + '\\'
__CodeList = []
#__rstfilepath = 'F:\LearnFile\language\python\project\gupiao\result.txt'
__rstfilepath = 'F:\\LearnFile\\language\\python\\project\\gupiao\\result.txt'
_file = None
#__filepath = 'F:\\data\\stock_all_20210405\\'    #放excel表格的位置
__filepath = 'F:\\data\\stock_' + _todayTime + '\\'

__regectStock_chongfu = {904, 905, 1361, 1362, 1363, 1364, 1365, 1620, 1621, 1622, 1623, 1624, 1625, 1626, 1627, 1861, 1862, 1863, 1864, 342, 394}
__regectStock_tuishi = {813, 614}
